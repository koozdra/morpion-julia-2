    ...
    while true
        ...
        if iteration % end_search_interval == 0 && max_score >= 100
            (endy_hash, endy) = maxby(function(pair)
                ...
                is_end_search_derived = haskey(end_search_derived, key)
                
                if already_end_searched 
                    0
                elseif is_end_search_derived
                    score - 0.5
                else
                    score
                end
